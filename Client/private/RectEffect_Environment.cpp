#include "stdafx.h"
#include "..\public\RectEffect_Environment.h"
#include "GameInstance.h"

CRectEffect_Environment::CRectEffect_Environment(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	:CGameObject(pDevice, pDeviceContext)
{
}

CRectEffect_Environment::CRectEffect_Environment(const CRectEffect_Environment & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRectEffect_Environment::NativeConstruct_Prototype()
{
...
HRESULT CRectEffect_Environment::NativeConstruct(void * pArg, _uint iCurrentScene)
{
	...
	m_fAlpha = GET_RANDOMFLOAT(0.05f, 0.1f);
	return S_OK;
}

_int CRectEffect_Environment::Tick(_double TimeDelta)
{
...
_int CRectEffect_Environment::LateTick(_double TimeDelta)
{
	...
	if (m_isReverse)
	{
		m_fAlpha += (_float)TimeDelta * 0.02f;
		if (m_fAlpha >= 0.1f)
			m_isReverse = false;
	}
	else
...
HRESULT CRectEffect_Environment::Render()
{
	...
	m_pVIBuffer->Render(9);

	return S_OK;
}

void CRectEffect_Environment::Effect_Time(_double TimeDetla)
{
	if (m_CDT_isPlay)
	{
...
void CRectEffect_Environment::Effect_TimeAcc(_bool* pPlay, _float fTotalTime, _double* pTargetTimeAcc, _double TimeDelta)
{
	if (*pPlay)
	{
...
HRESULT CRectEffect_Environment::Pattern_Option(_double TimeDelta)
{
...
_float CRectEffect_Environment::Option_Type(_bool* isOptionType, _double TimeAcc, _float fStartTime, _float fStartValue, _float fEndValue, _float fEndTime, _double TimeDelta)
{
	_float fResult = 0.0;
...
_float CRectEffect_Environment::Linear(_float fCurTime, _float fStartValue, _float fEndValue, _float fEndTime)
{
	if (0 == fEndTime)
...
_float CRectEffect_Environment::Ease_In_Quad(_float fCurTime, _float fStartValue, _float fEndValue, _float fEndTime)
{
	fCurTime /= fEndTime;
...
_float CRectEffect_Environment::Ease_Out_Quad(_float fCurTime, _float fStartValue, _float fEndValue, _float fEndTime)
{
	fCurTime /= fEndTime;
...
_float CRectEffect_Environment::Ease_In_Out(_float fCurTime, _float fStartValue, _float fEndValue, _float fEndTime)
{
	fCurTime /= fEndTime / 2;
	if (0 == fEndTime)
		return fEndValue + fStartValue;
...
_float CRectEffect_Environment::Ease_Out_Bounce(_float fCurTime, _float fStartValue, _float fEndValue, _float fEndTime)
{
	_float n1 = 7.5625f;
	_float d1 = 2.75f;
...
HRESULT CRectEffect_Environment::SetUp_Component()
{
	/* Com_Renderer */
...
HRESULT CRectEffect_Environment::SetUp_ConstantTable()
{
	...
	m_pVIBuffer->Set_RawValue("g_fAlpha", &m_fAlpha, sizeof(_float));
...
CRectEffect_Environment * CRectEffect_Environment::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CRectEffect_Environment*	pInstance = new CRectEffect_Environment(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created : CRectEffect_Environment");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CRectEffect_Environment::Clone(void * pArg, _uint iCurrentScene)
{
	CRectEffect_Environment*	pInstance = new CRectEffect_Environment(*this);
...
void CRectEffect_Environment::Free()
{
	__super::Free();
