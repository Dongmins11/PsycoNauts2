#include "stdafx.h"
#include "..\public\RectEffect_BoneMat.h"
#include "GameInstance.h"

CRectEffect_BoneMat::CRectEffect_BoneMat(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	:CGameObject(pDevice, pDeviceContext)
{
}

CRectEffect_BoneMat::CRectEffect_BoneMat(const CRectEffect_BoneMat & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRectEffect_BoneMat::NativeConstruct_Prototype()
{
...
HRESULT CRectEffect_BoneMat::NativeConstruct(void * pArg, _uint iCurrentScene)
{
...
_int CRectEffect_BoneMat::Tick(_double TimeDelta)
{
...
_int CRectEffect_BoneMat::LateTick(_double TimeDelta)
{
...
HRESULT CRectEffect_BoneMat::Render()
{
...
void CRectEffect_BoneMat::Effect_Time(_double TimeDetla)
{
	if (m_CDT_isPlay)
	{
...
void CRectEffect_BoneMat::Effect_TimeAcc(_bool* pPlay, _float fTotalTime, _double* pTargetTimeAcc, _double TimeDelta)
{
	if (*pPlay)
	{
...
HRESULT CRectEffect_BoneMat::Pattern_Option(_double TimeDelta)
{
...
_float CRectEffect_BoneMat::Option_Type(_bool* isOptionType, _double TimeAcc, _float fStartTime, _float fStartValue, _float fEndValue, _float fEndTime, _double TimeDelta)
{
	_float fResult = 0.0;
...
_float CRectEffect_BoneMat::Linear(_float fCurTime, _float fStartValue, _float fEndValue, _float fEndTime)
{
	if (0 == fEndTime)
...
_float CRectEffect_BoneMat::Ease_In_Quad(_float fCurTime, _float fStartValue, _float fEndValue, _float fEndTime)
{
	fCurTime /= fEndTime;
...
_float CRectEffect_BoneMat::Ease_Out_Quad(_float fCurTime, _float fStartValue, _float fEndValue, _float fEndTime)
{
	fCurTime /= fEndTime;
...
_float CRectEffect_BoneMat::Ease_In_Out(_float fCurTime, _float fStartValue, _float fEndValue, _float fEndTime)
{
	fCurTime /= fEndTime / 2;
	if (0 == fEndTime)
		return fEndValue + fStartValue;
...
_float CRectEffect_BoneMat::Ease_Out_Bounce(_float fCurTime, _float fStartValue, _float fEndValue, _float fEndTime)
{
	_float n1 = 7.5625f;
	_float d1 = 2.75f;
...
HRESULT CRectEffect_BoneMat::SetUp_Component()
{
	/* Com_Renderer */
...
HRESULT CRectEffect_BoneMat::SetUp_ConstantTable()
{
...
CRectEffect_BoneMat * CRectEffect_BoneMat::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CRectEffect_BoneMat*	pInstance = new CRectEffect_BoneMat(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created : CRectEffect_BoneMat");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CRectEffect_BoneMat::Clone(void * pArg, _uint iCurrentScene)
{
	CRectEffect_BoneMat*	pInstance = new CRectEffect_BoneMat(*this);
