#include "stdafx.h"
#include "..\public\LightBar.h"
#include "GameInstance.h"
#include "Camera_Fly.h"
#include "Player.h"

CLightBar::CLightBar(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	:CGameObject(pDevice, pDeviceContext)
{
}

CLightBar::CLightBar(const CLightBar & rhs)
	: CGameObject(rhs)
{
}

HRESULT CLightBar::NativeConstruct_Prototype()
{
...
HRESULT CLightBar::NativeConstruct(void * pArg, _uint iCurrentScene)
{
	...
	m_StrLayerName = TEXT("Layer_Compt_LightBar");
...
_int CLightBar::Tick(_double TimeDelta)
{
...
_int CLightBar::LateTick(_double TimeDelta)
{
...
void CLightBar::OnCollisionEnter(CCollisionObject & collision)
{
}

_bool CLightBar::Setting_CurlingIndex(_int * pCurlingIndex, _int * pDeleteIndex)
{
	CGameInstance* pGameInstance = GET_INSTANCE(CGameInstance);
...
void CLightBar::Stage_RenderBranch(_int iPlayerCurlingIndex)
{
	CGameInstance* pGameInstance = GET_INSTANCE(CGameInstance);
...
HRESULT CLightBar::SetUp_Component(_float3 vColSize, _float3 vColPos, _float3 vObjScale)
{
	m_vColPos = vColPos;
	/* Com_Renderer */
...
HRESULT CLightBar::SetUp_ConstantTable()
{
...
CLightBar * CLightBar::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CLightBar*	pInstance = new CLightBar(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created : CLightBar");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CLightBar::Clone(void * pArg, _uint iCurrentScene)
{
	CLightBar*	pInstance = new CLightBar(*this);
