#include "stdafx.h"
#include "..\public\RectEffect_Once.h"
#include "GameInstance.h"

CRectEffect_Once::CRectEffect_Once(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	:CGameObject(pDevice, pDeviceContext)
{
}

CRectEffect_Once::CRectEffect_Once(const CRectEffect_Once & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRectEffect_Once::NativeConstruct_Prototype()
{
...
HRESULT CRectEffect_Once::NativeConstruct(void * pArg, _uint iCurrentScene)
{
...
_int CRectEffect_Once::Tick(_double TimeDelta)
{
...
_int CRectEffect_Once::LateTick(_double TimeDelta)
{
...
HRESULT CRectEffect_Once::Render()
{
...
void CRectEffect_Once::Effect_Time(_double TimeDetla)
{

	Effect_TimeAcc(&m_CDT_isPlay, (m_tRectInfo.CDT_fStartTime + m_tRectInfo.CDT_fEndTime), &m_CDT_TimeAcc, TimeDetla);
...
void CRectEffect_Once::Effect_TimeAcc(_bool* pPlay, _float fTotalTime, _double* pTargetTimeAcc, _double TimeDelta)
{
	if (*pPlay)
	{
...
HRESULT CRectEffect_Once::Pattern_Option(_double TimeDelta)
{
...
_float CRectEffect_Once::Option_Type(_bool* isOptionType, _double TimeAcc, _float fStartTime, _float fStartValue, _float fEndValue, _float fEndTime, _double TimeDelta)
{
	_float fResult = 0.0;
...
_float CRectEffect_Once::Linear(_float fCurTime, _float fStartValue, _float fEndValue, _float fEndTime)
{
	if (0 == fEndTime)
...
_float CRectEffect_Once::Ease_In_Quad(_float fCurTime, _float fStartValue, _float fEndValue, _float fEndTime)
{
	fCurTime /= fEndTime;
...
_float CRectEffect_Once::Ease_Out_Quad(_float fCurTime, _float fStartValue, _float fEndValue, _float fEndTime)
{
	fCurTime /= fEndTime;
...
_float CRectEffect_Once::Ease_In_Out(_float fCurTime, _float fStartValue, _float fEndValue, _float fEndTime)
{
	fCurTime /= fEndTime / 2;
	if (0 == fEndTime)
		return fEndValue + fStartValue;
...
_float CRectEffect_Once::Ease_Out_Bounce(_float fCurTime, _float fStartValue, _float fEndValue, _float fEndTime)
{
	_float n1 = 7.5625f;
	_float d1 = 2.75f;
...
HRESULT CRectEffect_Once::SetUp_Component()
{
	/* Com_Renderer */
...
HRESULT CRectEffect_Once::SetUp_ConstantTable()
{
...
CRectEffect_Once * CRectEffect_Once::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CRectEffect_Once*	pInstance = new CRectEffect_Once(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created : CRectEffect_Once");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CRectEffect_Once::Clone(void * pArg, _uint iCurrentScene)
{
	CRectEffect_Once*	pInstance = new CRectEffect_Once(*this);
