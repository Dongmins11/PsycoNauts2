#include "stdafx.h"
#include "..\public\Stage4Mercial.h"
#include "GameInstance.h"
#include "Camera_Fly.h"
#include "Player.h"

CStage4Mercial::CStage4Mercial(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	:CGameObject(pDevice, pDeviceContext)
{
}

CStage4Mercial::CStage4Mercial(const CStage4Mercial & rhs)
	: CGameObject(rhs)
{
}

HRESULT CStage4Mercial::NativeConstruct_Prototype()
{
...
HRESULT CStage4Mercial::NativeConstruct(void * pArg, _uint iCurrentScene)
{
...
_int CStage4Mercial::Tick(_double TimeDelta)
{
...
_int CStage4Mercial::LateTick(_double TimeDelta)
{
...
HRESULT CStage4Mercial::Render()
{
	...
	m_pModelCom->Render_Custom_Light(m_iRenderPassArr, 5, m_isEmissiveActive);
	return S_OK;
}

void CStage4Mercial::OnCollisionEnter(CCollisionObject & collision)
{
}

_bool CStage4Mercial::Setting_CurlingIndex(_int * pCurlingIndex, _int * pDeleteIndex)
{
	CGameInstance* pGameInstance = GET_INSTANCE(CGameInstance);
...
void CStage4Mercial::Stage_RenderBranch(_int iPlayerCurlingIndex)
{
	CGameInstance* pGameInstance = GET_INSTANCE(CGameInstance);
...
HRESULT CStage4Mercial::SetUp_Component(_float3 vColSize, _float3 vColPos, _float3 vObjScale)
{
	m_vColPos = vColPos;
	/* Com_Renderer */
...
HRESULT CStage4Mercial::SetUp_ConstantTable()
{
...
CStage4Mercial * CStage4Mercial::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CStage4Mercial*	pInstance = new CStage4Mercial(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created : CStage4Mercial");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CStage4Mercial::Clone(void * pArg, _uint iCurrentScene)
{
	CStage4Mercial*	pInstance = new CStage4Mercial(*this);
