...
HRESULT CRectEffect::NativeConstruct(void * pArg, _uint iCurrentScene)
{
...
_int CRectEffect::Tick(_double TimeDelta)
{
	...
	else
	{
		...
		if (m_tRectInfo.I_isBillboard || m_pOptionCom->Get_LocalBillboard())
...
_int CRectEffect::LateTick(_double TimeDelta)
{
...
void CRectEffect::Effect_Time(_double TimeDetla)
{
	if (m_CDT_isPlay)
	{
...
void CRectEffect::Effect_TimeAcc(_bool* pPlay, _float fTotalTime, _double* pTargetTimeAcc, _double TimeDelta)
{
	if (*pPlay)
	{
...
HRESULT CRectEffect::Pattern_Option(_double TimeDelta)
{
...
_float CRectEffect::Option_Type(_bool* isOptionType, _double TimeAcc, _float fStartTime, _float fStartValue, _float fEndValue, _float fEndTime, _double TimeDelta)
{
	_float fResult = 0.0;
...
_float CRectEffect::Linear(_float fCurTime, _float fStartValue, _float fEndValue, _float fEndTime)
{
	if (0 == fEndTime)
...
_float CRectEffect::Ease_In_Quad(_float fCurTime, _float fStartValue, _float fEndValue, _float fEndTime)
{
	fCurTime /= fEndTime;
...
_float CRectEffect::Ease_Out_Quad(_float fCurTime, _float fStartValue, _float fEndValue, _float fEndTime)
{
	fCurTime /= fEndTime;
...
_float CRectEffect::Ease_In_Out(_float fCurTime, _float fStartValue, _float fEndValue, _float fEndTime)
{
	fCurTime /= fEndTime / 2;
	if (0 == fEndTime)
		return fEndValue + fStartValue;
...
_float CRectEffect::Ease_Out_Bounce(_float fCurTime, _float fStartValue, _float fEndValue, _float fEndTime)
{
	_float n1 = 7.5625f;
	_float d1 = 2.75f;
...
CRectEffect * CRectEffect::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	...
	{
		MSGBOX("Failed to Created : CRectEffect");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CRectEffect::Clone(void * pArg, _uint iCurrentScene)
{
