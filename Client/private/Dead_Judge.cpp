#include "stdafx.h"
#include "..\public\Dead_Judge.h"
#include "Camera_Fly.h"
#include "Static_Bell.h"

CDead_Judge::CDead_Judge(CJudge * _pJudge)
	:m_pJudge(_pJudge)
{
}

_bool CDead_Judge::Invoke(_double TimeDelta, CModel * _pModel, CTransform * _pTransform, CCharacterController* _pController)
{
...
CDead_Judge * CDead_Judge::Create(CJudge * _pJudge)
{
	CDead_Judge* pInstance = new CDead_Judge(_pJudge);

	return pInstance;
}

void CDead_Judge::Free()
{
}
