#include "stdafx.h"
#include "..\public\Board_R.h"
#include "GameInstance.h"

CBoard_R::CBoard_R(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	:CGameObject(pDevice, pDeviceContext)
{
}

CBoard_R::CBoard_R(const CBoard_R & rhs)
	: CGameObject(rhs)
{
}

HRESULT CBoard_R::NativeConstruct_Prototype()
{
...
HRESULT CBoard_R::NativeConstruct(void * pArg, _uint iCurrentScene)
{
	...
	WorldMatrix._41 = 64.f;
	WorldMatrix._42 = 8.5f;
	WorldMatrix._43 = 45.f;

	m_pTransformCom->Set_WorldMatrix(WorldMatrix);
	m_pTransformCom->Set_MyLook(XMVectorSet(-0.920f, -0.303f, -0.248f, 0.f));
	m_pTransformCom->Scaling(_float3(4.f, 4.f, 4.f));
	
	return S_OK;
}

_int CBoard_R::Tick(_double TimeDelta)
{
	if (!m_isRender)
		return 0;
...
_int CBoard_R::LateTick(_double TimeDelta)
{
...
HRESULT CBoard_R::SetUp_Component()
{
...
HRESULT CBoard_R::SetUp_ConstantTable()
{
...
CBoard_R * CBoard_R::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CBoard_R*	pInstance = new CBoard_R(pDevice, pDeviceContext);
...
CGameObject * CBoard_R::Clone(void * pArg, _uint iCurrentScene)
{
	CBoard_R*	pInstance = new CBoard_R(*this);
