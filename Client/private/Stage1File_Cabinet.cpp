#include "stdafx.h"
#include "..\public\Stage1File_Cabinet.h"
#include "GameInstance.h"
#include "Player.h"
#include "Camera_Fly.h"

CStage1File_Cabinet::CStage1File_Cabinet(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	:CGameObject(pDevice,pDeviceContext)
{
}

CStage1File_Cabinet::CStage1File_Cabinet(const CStage1File_Cabinet & rhs)
	: CGameObject(rhs)
{
}

HRESULT CStage1File_Cabinet::NativeConstruct_Prototype()
{
...
HRESULT CStage1File_Cabinet::NativeConstruct(void * pArg)
{
	OBJINFO	objinfo;
	if (nullptr != pArg)
	...
	m_StrLayerName = TEXT("Layer_Stage1File_Cabinet");
	m_StrModelName = objinfo.StrModelName;
	m_StrObjectFullName = TEXT("Prototype_GameObject_Stage1File_Cabinet");
...
_int CStage1File_Cabinet::Tick(_double TimeDelta)
{
...
_int CStage1File_Cabinet::LateTick(_double TimeDelta)
{
...
HRESULT CStage1File_Cabinet::Render()
{
...
void CStage1File_Cabinet::Fluctuate(_double TimeDelta)
{
}

void CStage1File_Cabinet::Add_Force(_fvector vDir, PxForceMode::Enum eMode)
{
	m_pColliderCom->Add_Force(vDir, eMode);
}

void CStage1File_Cabinet::Setting_Throwing(_fvector vDir)
{
}

void CStage1File_Cabinet::OnCollisionEnter(CCollisionObject & collision)
{
}

void CStage1File_Cabinet::OnCollisionStay(CCollisionObject & collision)
{
}

void CStage1File_Cabinet::OnCollisionExit(CCollisionObject & collision)
{
}

void CStage1File_Cabinet::OnTriggerEnter(CCollisionObject & collision)
{
}

void CStage1File_Cabinet::SettingActorActive()
{
	if (!m_pColliderCom)
		return;
...
_bool CStage1File_Cabinet::Setting_CurlingIndex(_int * pCurlingIndex, _int * pDeleteIndex)
{
	CGameInstance* pGameInstance = GET_INSTANCE(CGameInstance);
...
void CStage1File_Cabinet::Stage_RenderBranch(_int iPlayerCurlingIndex)
{
	CGameInstance* pGameInstance = GET_INSTANCE(CGameInstance);
...
HRESULT CStage1File_Cabinet::SetUp_Component(_float3 vColSize, _float3 vColPos, _float3 vObjScale)
{
	m_vColPos = vColPos;
	/* Com_Renderer */
	...
	if (vLength > 0.f)
	{
		...
		//if (m_eLayerType == LayerType::LAYERTYPE_STATIC)
...
HRESULT CStage1File_Cabinet::SetUp_ConstantTable()
{
...
void CStage1File_Cabinet::OnControllerCollisionHit(CCollisionObject & collision)
{
}

CStage1File_Cabinet * CStage1File_Cabinet::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CStage1File_Cabinet*	pInstance = new CStage1File_Cabinet(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created : CStage1File_Cabinet");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CStage1File_Cabinet::Clone(void * pArg, _uint iSceneIndex)
{
	CStage1File_Cabinet*	pInstance = new CStage1File_Cabinet(*this);
