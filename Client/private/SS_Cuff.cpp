#include "stdafx.h"
#include "..\public\SS_Cuff.h"
#include "GameInstance.h"
#include "Camera_Fly.h"
#include "Player.h"

CSS_Cuff::CSS_Cuff(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	:CGameObject(pDevice, pDeviceContext)
{
}

CSS_Cuff::CSS_Cuff(const CSS_Cuff & rhs)
	: CGameObject(rhs)
{
}

HRESULT CSS_Cuff::NativeConstruct_Prototype()
{
...
HRESULT CSS_Cuff::NativeConstruct(void * pArg, _uint iCurrentScene)
{
	...
	m_StrLayerName = TEXT("Layer_Compt_SS_Cuff");
...
_int CSS_Cuff::Tick(_double TimeDelta)
{
...
_int CSS_Cuff::LateTick(_double TimeDelta)
{
...
void CSS_Cuff::OnCollisionEnter(CCollisionObject & collision)
{
}

_bool CSS_Cuff::Setting_CurlingIndex(_int * pCurlingIndex, _int * pDeleteIndex)
{
	CGameInstance* pGameInstance = GET_INSTANCE(CGameInstance);
...
void CSS_Cuff::Stage_RenderBranch(_int iPlayerCurlingIndex)
{
	CGameInstance* pGameInstance = GET_INSTANCE(CGameInstance);
...
HRESULT CSS_Cuff::SetUp_Component(_float3 vColSize, _float3 vColPos, _float3 vObjScale)
{
	m_vColPos = vColPos;
	/* Com_Renderer */
...
HRESULT CSS_Cuff::SetUp_ConstantTable()
{
...
CSS_Cuff * CSS_Cuff::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CSS_Cuff*	pInstance = new CSS_Cuff(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created : CSS_Cuff");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CSS_Cuff::Clone(void * pArg, _uint iCurrentScene)
{
	CSS_Cuff*	pInstance = new CSS_Cuff(*this);
