#include "stdafx.h"
#include "..\public\CencerB_Left_Trail.h"
#include "GameInstance.h"

CCencerB_Left_Trail::CCencerB_Left_Trail(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	:CGameObject(pDevice, pDeviceContext)
{
}

CCencerB_Left_Trail::CCencerB_Left_Trail(const CCencerB_Left_Trail & rhs)
	: CGameObject(rhs)
{
}

HRESULT CCencerB_Left_Trail::NativeConstruct_Prototype()
{
...
HRESULT CCencerB_Left_Trail::NativeConstruct(void * pArg, _uint iCurrentScene)
{
...
_int CCencerB_Left_Trail::Tick(_double TimeDelta)
{
...
_int CCencerB_Left_Trail::LateTick(_double TimeDelta)
{
...
HRESULT CCencerB_Left_Trail::Render()
{
...
HRESULT CCencerB_Left_Trail::SetUp_Component()
{
...
HRESULT CCencerB_Left_Trail::SetUp_ConstantTable()
{
...
CCencerB_Left_Trail * CCencerB_Left_Trail::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CCencerB_Left_Trail*	pInstance = new CCencerB_Left_Trail(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created : CCencerB_Left_Trail");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CCencerB_Left_Trail::Clone(void * pArg, _uint iCurrentScene)
{
	CCencerB_Left_Trail*	pInstance = new CCencerB_Left_Trail(*this);
