#include "stdafx.h"
#include "..\public\HippoLegs.h"
#include "GameInstance.h"
#include "Camera_Fly.h"
#include "Player.h"

CHippoLegs::CHippoLegs(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	:CGameObject(pDevice, pDeviceContext)
{
}

CHippoLegs::CHippoLegs(const CHippoLegs & rhs)
	: CGameObject(rhs)
{
}

HRESULT CHippoLegs::NativeConstruct_Prototype()
{
...
HRESULT CHippoLegs::NativeConstruct(void * pArg, _uint iCurrentScene)
{
	...
	m_StrLayerName = TEXT("Layer_HippoLegs");
...
_int CHippoLegs::Tick(_double TimeDelta)
{
	...
	m_pTransformCom->RotationPerSec(m_pTransformCom->Get_State(CTransform::STATE_UP), XMConvertToRadians(m_fMove));

	RELEASE_INSTANCE(CGameInstance);
	return _int();
}

_int CHippoLegs::LateTick(_double TimeDelta)
{
...
void CHippoLegs::OnCollisionEnter(CCollisionObject & collision)
{
}

_bool CHippoLegs::Setting_CurlingIndex(_int * pCurlingIndex, _int * pDeleteIndex)
{
	CGameInstance* pGameInstance = GET_INSTANCE(CGameInstance);
...
void CHippoLegs::Stage_RenderBranch(_int iPlayerCurlingIndex)
{
	CGameInstance* pGameInstance = GET_INSTANCE(CGameInstance);
...
void CHippoLegs::SettingMyCount()
{
	CGameInstance* pGameInstance = GET_INSTANCE(CGameInstance);

	_uint LegCount = pGameInstance->Get_LayerSize(SCENE_STAGE03, TEXT("Layer_HippoLegs"));
	
	m_iMYObjectCount = LegCount;
...
HRESULT CHippoLegs::SetUp_Component(_float3 vColSize, _float3 vColPos, _float3 vObjScale)
{
	m_vColPos = vColPos;
	/* Com_Renderer */
...
HRESULT CHippoLegs::SetUp_ConstantTable()
{
...
CHippoLegs * CHippoLegs::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CHippoLegs*	pInstance = new CHippoLegs(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created : CHippoLegs");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CHippoLegs::Clone(void * pArg, _uint iCurrentScene)
{
	CHippoLegs*	pInstance = new CHippoLegs(*this);
