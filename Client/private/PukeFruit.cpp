...
CPukeFruit::CPukeFruit(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	:CGameObject(pDevice, pDeviceContext)
{
}

CPukeFruit::CPukeFruit(const CPukeFruit & rhs)
	: CGameObject(rhs)
{
}

HRESULT CPukeFruit::NativeConstruct_Prototype()
{
	return S_OK;
}

HRESULT CPukeFruit::NativeConstruct(void* _pArg, _uint iSceneIndex)
{
...
_int CPukeFruit::Tick(_double TimeDelta)
{
...
_int CPukeFruit::LateTick(_double TimeDelta)
{
...
HRESULT CPukeFruit::SetUp_Component()
{
	/* Com_Renderer */
...
HRESULT CPukeFruit::SetUp_ConstantTable()
{
...
CPukeFruit * CPukeFruit::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CPukeFruit*	pInstance = new CPukeFruit(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created : CPukeFruit");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CPukeFruit::Clone(void * pArg, _uint iSceneIndex)
{
	CPukeFruit*	pInstance = new CPukeFruit(*this);
