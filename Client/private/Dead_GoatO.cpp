#include "stdafx.h"
#include "..\public\Dead_GoatO.h"

CDead_GoatO::CDead_GoatO(CGoatOtto * _pGoat)
	:m_pGoat(_pGoat)
{
}

_bool CDead_GoatO::Invoke(_double TimeDelta, CModel * _pModel, CTransform * _pTransform, CCharacterController* _pController)
{
...
CDead_GoatO * CDead_GoatO::Create(CGoatOtto * _pGoat)
{
	CDead_GoatO* pInstance = new CDead_GoatO(_pGoat);

	return pInstance;
}

void CDead_GoatO::Free()
{
}
