#include "stdafx.h"
#include "..\public\StationRamp0.h"
#include "GameInstance.h"
#include "Camera_Fly.h"
#include "Player.h"

CStationRamp0::CStationRamp0(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	:CGameObject(pDevice, pDeviceContext)
{
}

CStationRamp0::CStationRamp0(const CStationRamp0 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CStationRamp0::NativeConstruct_Prototype()
{
...
HRESULT CStationRamp0::NativeConstruct(void * pArg, _uint iCurrentScene)
{
	...
	m_StrLayerName = TEXT("Layer_Compt_StationRamp0");
...
_int CStationRamp0::Tick(_double TimeDelta)
{
...
_int CStationRamp0::LateTick(_double TimeDelta)
{
...
void CStationRamp0::OnCollisionEnter(CCollisionObject & collision)
{
}

_bool CStationRamp0::Setting_CurlingIndex(_int * pCurlingIndex, _int * pDeleteIndex)
{
	CGameInstance* pGameInstance = GET_INSTANCE(CGameInstance);
...
void CStationRamp0::Stage_RenderBranch(_int iPlayerCurlingIndex)
{
	CGameInstance* pGameInstance = GET_INSTANCE(CGameInstance);
...
HRESULT CStationRamp0::SetUp_Component(_float3 vColSize, _float3 vColPos, _float3 vObjScale)
{
	m_vColPos = vColPos;
	/* Com_Renderer */
...
HRESULT CStationRamp0::SetUp_ConstantTable()
{
...
CStationRamp0 * CStationRamp0::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CStationRamp0*	pInstance = new CStationRamp0(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created : CStationRamp0");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CStationRamp0::Clone(void * pArg, _uint iCurrentScene)
{
	CStationRamp0*	pInstance = new CStationRamp0(*this);
