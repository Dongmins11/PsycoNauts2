#include "stdafx.h"
#include "..\public\Onion.h"

COnion::COnion(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
...
HRESULT COnion::NativeConstruct_Prototype()
{
...
HRESULT COnion::NativeConstruct(void * pArg, _uint iCurrentScene)
{
	...
	m_StrLayerName = TEXT("Layer_ONION");
	Setting_ModelNames();
	m_StrObjectFullName = TEXT("Prototpye_GameObject_ONION");
	...
	//테스트코드
	//m_iCookingNumber = (2 << (_uint)CookType::COOK_CUT);
	return S_OK;
}

_int COnion::Tick(_double TimeDelta)
{
...
_int COnion::LateTick(_double TimeDelta)
{
...
void COnion::Setting_ModelNames()
{
	m_StrModelName[FMT_IDLE] = TEXT("Prototype_Component_Model_Onion0");
	m_StrModelName[FMT_BOILED] = TEXT("Prototype_Component_Model_Onion0");
	m_StrModelName[FMT_CUTTING] = TEXT("Prototype_Component_Model_OnionSliced0");
	m_StrModelName[FMT_BLENDED] = TEXT("Prototype_Component_Model_Onion0");
	m_StrModelName[FMT_GRIDDLED] = TEXT("Prototype_Component_Model_Onion0");
}


HRESULT COnion::SetUp_Component()
{
	/* Com_Renderer */
...
HRESULT COnion::SetUp_ConstantTable()
{
...
COnion * COnion::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	COnion*	pInstance = new COnion(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created : COnion");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * COnion::Clone(void * pArg, _uint iCurrentScene)
{
	COnion*	pInstance = new COnion(*this);
