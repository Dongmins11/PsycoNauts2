...
_int CNpcCoach::Tick(_double TimeDelta)
{
	...
	//if (true == pGameInstance->Key_Down(VK_NUMPAD5)) /* 시작  ->CLOUD_START    몬스터 다 잡으면 CLOUD_11   지퍼랑 충돌이 되면 CLOUD_16  */
	//{
	...
	//	RELEASE_INSTANCE(CGameInstance);
	//}
	//if (true == pGameInstance->Key_Down(VK_NUMPAD6)) /* 몬스터 다잡았을떄 11번 */
	//{
	//	//CGameInstance* pGameInstnace = GET_INSTANCE(CGameInstance);
