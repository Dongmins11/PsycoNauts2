...
{
public:
	enum UPDATE_TYPE { TYPE_OPTION, TYPE_BILLBOARD, TYPE_SMOKE_RANDING, TYPE_SMOKE_DIE, TYPE_SPARK, 
...
private:
	explicit CEffect_RectParticle(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
...
public:
	static CEffect_RectParticle* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
