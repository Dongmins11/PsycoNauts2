...
class CLightBar final :public CGameObject
{
private:
	CLightBar(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CLightBar(const CLightBar& rhs);
	virtual ~CLightBar() = default;
...
public:
	static CLightBar* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
