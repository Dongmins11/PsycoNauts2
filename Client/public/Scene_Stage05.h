...
class CScene_Stage05 final :public CScene
{
public:
	explicit CScene_Stage05(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	virtual ~CScene_Stage05() = default;
public:
...
private:
	...
	_uint		m_iPhaseNum = 0;
public:
	static CScene_Stage05* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
