...
BEGIN(Client)
class CRectEffect_Environment final :public CGameObject
{
...
protected:
	explicit CRectEffect_Environment(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CRectEffect_Environment(const CRectEffect_Environment& rhs);
	virtual ~CRectEffect_Environment() = default;
...
public:
	static CRectEffect_Environment* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
