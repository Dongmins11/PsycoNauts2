...
BEGIN(Client)
class CAttack_GoatH : public CBTNode
{
private:
	explicit CAttack_GoatH(class CGoatHollis* _pGoat);
	virtual ~CAttack_GoatH() = default;
...
public:
	static CAttack_GoatH* Create(CGoatHollis* _pGoat);
