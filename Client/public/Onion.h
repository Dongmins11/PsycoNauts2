...
class COnion final :public CFruit
{
protected:
	explicit COnion(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit COnion(const COnion& rhs);
	virtual ~COnion() = default;
...
public:
	static COnion* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
