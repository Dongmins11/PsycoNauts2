...
class CStationRamp1 final :public CGameObject
{
private:
	CStationRamp1(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CStationRamp1(const CStationRamp1& rhs);
	virtual ~CStationRamp1() = default;
...
public:
	static CStationRamp1* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
