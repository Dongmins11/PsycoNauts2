...
BEGIN(Client)
class CCensorB_AttTriggerR final :public CGameObject
{
private:
	CCensorB_AttTriggerR(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CCensorB_AttTriggerR(const CCensorB_AttTriggerR& rhs);
	virtual ~CCensorB_AttTriggerR() = default;
...
public:
	static CCensorB_AttTriggerR* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
