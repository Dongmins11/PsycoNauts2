...
class CAWaterCooler final :public CGameObject
{
private:
	CAWaterCooler(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CAWaterCooler(const CAWaterCooler& rhs);
	virtual ~CAWaterCooler() = default;
...
public:
	static CAWaterCooler* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
