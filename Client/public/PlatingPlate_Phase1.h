...
class CPlatingPlate_Phase1 final :public CGameObject
{
protected:
	explicit CPlatingPlate_Phase1(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CPlatingPlate_Phase1(const CPlatingPlate_Phase1& rhs);
	virtual ~CPlatingPlate_Phase1() = default;
...
private:
	...
	CGameObject*			m_pFruitCollider[3] = { nullptr };
...
public:
	static CPlatingPlate_Phase1* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
