...
class CPlayer_Throw_Left final : public CPlayer_ParentAnim
{
	DECLARE_SINGLETON(CPlayer_Throw_Left)
private:
	explicit CPlayer_Throw_Left();
	virtual ~CPlayer_Throw_Left() = default;
public:
