...
class CPlatingPlate_Phase2 final :public CGameObject
{
protected:
	explicit CPlatingPlate_Phase2(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CPlatingPlate_Phase2(const CPlatingPlate_Phase2& rhs);
	virtual ~CPlatingPlate_Phase2() = default;
...
private:
	...
	CGameObject*			m_pFruitCollider[4] = { nullptr };
...
public:
	static CPlatingPlate_Phase2* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
