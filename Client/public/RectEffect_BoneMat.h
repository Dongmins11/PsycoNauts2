...
BEGIN(Client)
class CRectEffect_BoneMat final :public CGameObject
{
...
protected:
	explicit CRectEffect_BoneMat(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CRectEffect_BoneMat(const CRectEffect_BoneMat& rhs);
	virtual ~CRectEffect_BoneMat() = default;
...
public:
	static CRectEffect_BoneMat* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
