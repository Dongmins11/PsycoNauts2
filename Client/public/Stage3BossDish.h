...
class CStage3BossDish final : public CGameObject
{
private:
	CStage3BossDish(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CStage3BossDish(const CStage3BossDish& rhs);
	virtual ~CStage3BossDish() = default;
...
public:
	void Set_Render_BossDish() { m_RenderInterpolate = true; }
...
public:
	static CStage3BossDish* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
