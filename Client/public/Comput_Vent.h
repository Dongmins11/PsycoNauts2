...
class CComput_Vent final :public CGameObject
{
private:
	CComput_Vent(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CComput_Vent(const CComput_Vent& rhs);
	virtual ~CComput_Vent() = default;
...
public:
	static CComput_Vent* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
