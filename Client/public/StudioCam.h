...
class CStudioCam final :public CGameObject
{
private:
	CStudioCam(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CStudioCam(const CStudioCam& rhs);
	virtual ~CStudioCam() = default;
...
public:
	static CStudioCam* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
