...
BEGIN(Client)
class CRectEffect_Once final :public CGameObject
{
...
protected:
	explicit CRectEffect_Once(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CRectEffect_Once(const CRectEffect_Once& rhs);
	virtual ~CRectEffect_Once() = default;
...
public:
	static CRectEffect_Once* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
