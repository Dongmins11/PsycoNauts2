...
class CStationRamp0 final :public CGameObject
{
private:
	CStationRamp0(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CStationRamp0(const CStationRamp0& rhs);
	virtual ~CStationRamp0() = default;
...
public:
	static CStationRamp0* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
